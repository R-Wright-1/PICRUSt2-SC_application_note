...
overall_folder = '/Users/robynwright/Dropbox/Papers_writing/PICRUSt2_database_application_note/compile_output/'
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/number_of_taxa.png', dpi=600, bbox_inches='tight')
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2_database_application_note/figures/number_of_taxa_horizontal.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/nsti_bacteria_and_archaea.png', dpi=600, bbox_inches='tight')
```
...
#plt.show()
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/nsti_best.png', dpi=600, bbox_inches='tight')
```
...
for trait in ['EC', 'KO', 'path']:
  ...
  plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_'+trait+'.png', dpi=600, bbox_inches='tight')
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_all.png', dpi=600, bbox_inches='tight')
...
for trait in ['EC', 'KO', 'path']:
  ...
  plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_'+trait+'_mgs.png', dpi=600, bbox_inches='tight')
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_combined_mgs.png', dpi=600, bbox_inches='tight')
```
...
for trait in ['EC', 'KO', 'path']:
  ...
  ti = plt.title(trait.replace('path', 'Pathways').replace('KO', 'KEGG orthologs').replace('EC', 'EC numbers'), fontweight='bold')
  plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_'+trait+'.png', dpi=600, bbox_inches='tight')
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_all.png', dpi=600, bbox_inches='tight')
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_combined_mgs.png', dpi=600, bbox_inches='tight')
...
for trait in ['EC', 'KO', 'path']:
  ...
  handles = [Line2D([0], [0], marker='s', color='w', label=databases[s], markerfacecolor=colours[s], markersize=12) for s in range(len(databases))]
  legend = ax.legend(handles=handles, loc='lower right')
  plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_'+trait+'_mgs.png', dpi=600, bbox_inches='tight')
...
yl = plt.ylim([0, 100])
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/relative_abundance_class.png', dpi=600, bbox_inches='tight')
...
for trait in ['EC', 'KO']:
  ...
  handles = [Line2D([0], [0], marker='s', color='w', label=databases[s], markerfacecolor=colours[s], markersize=12) for s in range(len(databases))]
  legend = ax.legend(handles=handles, loc='lower right')
  plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_'+trait+'_mock.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_combined_mock.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/distance_braycurtis_combined_mock_trimmed.png', dpi=600, bbox_inches='tight')
```
...
for trait in ['EC', 'KO']:
  ...
  handles = [Line2D([0], [0], marker='s', color='w', label=databases[s], markerfacecolor=colours[s], markersize=12) for s in range(len(databases))]
  legend = ax.legend(handles=handles, loc='lower right')
  plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_'+trait+'_mock.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_combined_mock.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/correlation_combined_mock_trimmed.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig('/Users/robynwright/Dropbox/Papers_writing/PICRUSt2 database application note/figures/Overall_plot.png', dpi=600, bbox_inches='tight')
```
...
databases = ['PICRUSt2-oldIMG', 'PICRUSt2-MPGA']
...
lg = ax1.legend(handles=handles, loc='upper center', fontsize=8)
...
plt.savefig(overall_folder+'figures/fig2_nsti_datasets.png', dpi=600, bbox_inches='tight')
```
...
plt.savefig(overall_folder+'figures/fig3_correlation_default_updated.png', dpi=600, bbox_inches='tight')
```
...
for t in range(len(traits)):
  ...
  databases = ['PICRUSt2-oldIMG', 'PICRUSt2-MPGA']
  handles = [Line2D([0], [0], marker='s', color='w', label=databases[s], markerfacecolor=colours[s], markersize=12) for s in range(len(databases))]
  if t == 1: legend = ax2.legend(handles=handles, loc='lower right')
  #yl = plt.ylim([0.17, 0.73])

plt.savefig(overall_folder+'figures/fig4_mgs_correlation_distance.png', dpi=600, bbox_inches='tight')
```
...
ti = ax_db.set_title('a) MPGA construction', fontweight='bold', loc='left', fontsize=16)
ti = ax_annot_def_title.set_title('b) Functions included', fontweight='bold', loc='left', fontsize=16)
ti = ax1.set_title('c) Number of taxa included', fontweight='bold', loc='left', fontsize=16)
...
plt.sca(ax_annot_upd_title)
tx = ax_annot_upd_title.text(0, 0.5, 'MPGA', fontweight='bold', fontsize=12, ha='center', va='center')
li = plt.xlim([-0.5, 0.5]), plt.ylim([0, 1])
xt = plt.xticks([]), plt.yticks([])
